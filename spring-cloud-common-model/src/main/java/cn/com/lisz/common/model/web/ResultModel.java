...
public class ResultModel<T> {
	...
	public ResultModel(int status, T data) {
		this.status = status;
		this.data = data;
	}
	 ...
	 * 普通失败提示信息
	 */
	public ResultModel<T> failed(String message) {
		this.status = FAILED;
		this.message = message;
		return this;
	}
	 ...
	 *            错误信息
	 */
	public ResultModel<T> paramError(String message) {
	 ...
	 *            错误信息
	 */
	public ResultModel<T> unauthorized() {
	 ...
	 *            错误信息
	 */
	public ResultModel<T> forbidden(String message) {
